...
public class CompositeQuery {
	...
	public static String get_aCondition_For_Oracle(String columnName, String value) {
		...
		if ("restKind".equals(columnName) || "RESTREVIEWSTATUS".equals(columnName) || "restNo".equals(columnName)
				|| "restLongTitude".equals(columnName) || "restLatitude".equals(columnName)) // 用於其他
			aCondition = columnName + "=" + value;
		else if ("restName".equals(columnName) || "restAdd".equals(columnName) || "restPhone".equals(columnName)
				|| "restLocate".equals(columnName) || "restIntro".equals(columnName)) // 用於varchar
	...
	public static void main(String argv[]) {
		...
		String finalSQL = "select * from rest " + CompositeQuery.get_WhereCondition(map) + "order by restNo";
