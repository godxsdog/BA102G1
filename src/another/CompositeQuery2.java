...
public class CompositeQuery2 {
	...
	public static String get_aCondition_For_Oracle(String columnName, String value) {
		...
		if ("actNo".equals(columnName) || "actStatus".equals(columnName) || "actULimit".equals(columnName)
				|| "actLLimit".equals(columnName) || "actKind".equals(columnName)) // 用於其他
			aCondition = columnName + "=" + value;
		else if ("restMemId".equals(columnName) || "actName".equals(columnName) || "actContent".equals(columnName)
				|| "actAnotherKind".equals(columnName)) // 用於varchar
	...
	public static void main(String argv[]) {
		...
		String finalSQL = "select * from activity " + CompositeQuery2.get_WhereCondition(map) + "order by actNo";
